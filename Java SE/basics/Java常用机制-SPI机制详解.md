...
![img](assets/java-advanced-spi-1-16687637839313.png)

可以看到此时迭代器中有两个驱动，mysql和postgresql的都被加载了。

#### 2.SPI机制 - Common-Logging
...
![img](assets/java-advanced-spi-2.jpg)
...
- 实现和接口在一个包中。
  ...
  ![img](assets/java-advanced-spi-7.png)

  ![img](assets/java-advanced-spi-6.png)
