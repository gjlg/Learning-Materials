...
到i2的赋值更为灵活。但是请注意，如果字段由static和final修饰，仅能在声明时赋值或声明后在静态代码块中赋值，因为该字段不属于对象，属于这个类。
...
![img](./assets/java-thread-x-key-final-1.png)
...
![img](./assets/java-thread-x-key-final-2.png)
...
![img](./assets/java-thread-x-key-final-3.png)
...
![img](./assets/java-thread-x-key-final-4.png)
